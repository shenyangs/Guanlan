...
_QUALITY_INTENT_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "ecommerce": {
        "name": "电商/零售/跨境",
        "terms": ("电商", "零售", "跨境", "出海", "品牌", "渠道", "供应链", "产业带", "平台", "新消费", "抖音小店", "小店", "团购", "抖音团购", "真实商家", "实体店", "加盟", "本地生活", "餐馆", "茶饮", "食材成本", "配菜", "海带苗", "鸡枞菌", "姜饼瓜"),
    ...
    "finance": {
        "name": "财经/资本市场",
        "terms": ("财经", "股票", "股价", "财报", "融资", "上市", "投资", "基金", "债券", "宏观", "资本市场", "英伟达", "nvidia", "大跌", "etf", "质押", "银行倒闭", "fedwatch", "降息", "净值", "利空", "下跌原因", "ftse", "gilts", "bond yields", "imf", "bank of england"),
    ...
    "tech": {
        "name": "技术/开发者",
        "terms": ("技术", "开源", "框架", "模型", "api", "sdk", "github", "开发者", "部署", "bug", "benchmark", "mcp", "教程", "自动加字幕", "剪映", "winui3", "winui 3", "windows app sdk", "sam 3", "segment anything with concepts", "ultralytics", *_ROBOTICS_AI_TERMS),
