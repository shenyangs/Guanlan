...
_QUALITY_INTENT_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "local_life": {
        "name": "本地生活/到店攻略",
        "terms": ("骑行路线", "骑行", "brunch", "咖啡店", "咖啡馆", "书店", "深夜书店", "发呆", "凌晨", "深夜", "不排队", "看海", "夜景", "旅行攻略", "周末好去处", "横琴", "自驾", "景区", "赛里木湖", "喀拉峻", "夏塔", "库尔德宁", "琼库什台"),
