...
_QUALITY_INTENT_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "medical_health": {
        "name": "医疗/健康高影响信息",
        "terms": ("医疗", "疾病", "药", "药品", "治疗", "治未病", "中医药", "中医养生", "中医养生保健", "宣传疗效", "医疗广告", "诊断", "症状", "临床", "指南", "医生", "医院", "孕期", "怀孕", "布洛芬", "肺结节", "肌酸", "视黄醇", "敏感肌", "猫咪", "呕吐", "fda", "cdc", "who", "medical", "clinical", "treatment"),
    ...
    "finance": {
        "name": "财经/资本市场",
        "terms": ("财经", "股票", "股价", "财报", "融资", "上市", "投资", "基金", "债券", "宏观", "资本市场", "英伟达", "nvidia", "大跌", "etf", "质押", "银行倒闭", "fedwatch", "降息", "净值", "持仓", "跟踪指数", "基金概况", "成立日期", "利空", "下跌原因", "ftse", "gilts", "bond yields", "imf", "bank of england", "贷款市场报价利率", "lpr", "住房贷款利率", "支付体系运行总体情况", "移动支付", "业务金额", "业务笔数", "国家统计局", "70个大中城市", "商品住宅销售价格", "居民收入和消费支出"),
