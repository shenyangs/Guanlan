...
SOURCE_PACKS: dict[str, tuple[SourcePackEntry, ...]] = {
    ...
    "tech_research": (
        ...
        SourcePackEntry("Microsoft AI Blog", "news.microsoft.com", "company_primary", "company_primary", "vertical", 0.74, 0.16, 0.78),
        SourcePackEntry("NVIDIA Generative AI Blog", "developer.nvidia.com", "developer", "developer_primary", "vertical", 0.72, 0.24, 0.78),
        ...
        SourcePackEntry("The Decoder", "the-decoder.com", "tech_dev", "ai_media_report", "vertical", 0.54, 0.36, 0.8),
        SourcePackEntry("TechCrunch AI", "techcrunch.com", "tech_dev", "ai_media_report", "vertical", 0.54, 0.34, 0.82),
        SourcePackEntry("VentureBeat AI", "venturebeat.com", "tech_dev", "ai_media_report", "vertical", 0.52, 0.34, 0.78),
        SourcePackEntry("Wired AI", "wired.com", "tech_dev", "ai_media_report", "vertical", 0.56, 0.32, 0.72),
        SourcePackEntry("MarkTechPost", "marktechpost.com", "tech_dev", "ai_research_news", "vertical", 0.46, 0.38, 0.76),
        SourcePackEntry("Artificial Intelligence News", "artificialintelligence-news.com", "tech_dev", "ai_media_report", "vertical", 0.42, 0.4, 0.72),
    ),
    "finance_research": (
    ...
    "developer_research": (
        ...
        SourcePackEntry("Linux.do", "linux.do", "tech_dev", "developer_discussion", "sample", 0.34, 0.88, 0.88, notes="中文开发者、AI 工具和开源社区高活跃样本；讨论不替代项目原文。"),
        SourcePackEntry("NodeSeek", "nodeseek.com", "tech_dev", "hosting_developer_discussion", "sample", 0.3, 0.82, 0.82, notes="云服务、主机和开发者运维社区样本；注意商家与用户立场。"),
    ...
    "academic_discovery": (
        SourcePackEntry("Crossref", "crossref.org", "academic", "doi_metadata_primary", "core", 0.86, 0.24, 0.78, notes="DOI 注册元数据和出版物发现入口；元数据不等于论文结论。"),
        SourcePackEntry("DataCite", "datacite.org", "academic", "dataset_doi_metadata", "core", 0.86, 0.24, 0.78, notes="数据集、软件和研究产出 DOI 元数据入口。"),
        SourcePackEntry("OpenAlex", "openalex.org", "academic", "scholarly_graph", "core", 0.72, 0.48, 0.8, notes="开放学术图谱，适合作者、机构、主题和引用关系发现。"),
        SourcePackEntry("PubMed/NCBI", "ncbi.nlm.nih.gov", "academic", "biomedical_index", "core", 0.9, 0.24, 0.82, notes="生物医学文献记录入口；需区分摘要、全文与证据等级。"),
        SourcePackEntry("Europe PMC", "europepmc.org", "academic", "biomedical_index", "core", 0.84, 0.3, 0.8),
        SourcePackEntry("Zenodo", "zenodo.org", "academic", "research_repository", "vertical", 0.68, 0.5, 0.76, notes="论文、数据、软件和预印本仓储；记录类型与同行评审状态需单独核验。"),
        SourcePackEntry("DOAJ", "doaj.org", "academic", "journal_directory", "vertical", 0.78, 0.28, 0.62),
        SourcePackEntry("Semantic Scholar", "semanticscholar.org", "academic", "scholarly_discovery", "vertical", 0.64, 0.52, 0.78),
        SourcePackEntry("CORE", "core.ac.uk", "academic", "open_access_discovery", "vertical", 0.68, 0.42, 0.72),
        SourcePackEntry("Unpaywall", "unpaywall.org", "academic", "open_access_status", "vertical", 0.76, 0.22, 0.72),
    ),
    "standards_research": (
        SourcePackEntry("国家标准全文公开系统", "std.samr.gov.cn", "standards", "standard_original", "core", 0.96, 0.08, 0.58),
        SourcePackEntry("全国网络安全标准化技术委员会", "tc260.org.cn", "standards", "standard_original", "core", 0.94, 0.1, 0.62),
        SourcePackEntry("ISO", "iso.org", "standards", "standard_catalog", "core", 0.96, 0.08, 0.58),
        SourcePackEntry("IEC", "iec.ch", "standards", "standard_catalog", "core", 0.96, 0.08, 0.58),
        SourcePackEntry("NIST", "nist.gov", "standards", "standard_original", "core", 0.96, 0.08, 0.66),
        SourcePackEntry("W3C", "w3.org", "standards", "web_standard_original", "core", 0.94, 0.1, 0.72),
        SourcePackEntry("IETF", "ietf.org", "standards", "internet_standard_original", "core", 0.94, 0.1, 0.72),
        SourcePackEntry("RFC Editor", "rfc-editor.org", "standards", "rfc_original", "core", 0.96, 0.08, 0.72),
        SourcePackEntry("OASIS Open", "oasis-open.org", "standards", "standard_original", "vertical", 0.9, 0.1, 0.62),
        SourcePackEntry("IEEE Standards", "standards.ieee.org", "standards", "standard_catalog", "vertical", 0.92, 0.08, 0.6),
        SourcePackEntry("ETSI", "etsi.org", "standards", "telecom_standard_original", "vertical", 0.92, 0.08, 0.62),
        SourcePackEntry("ITU", "itu.int", "standards", "telecom_standard_original", "vertical", 0.94, 0.08, 0.62),
    ),
    "wps_office_research": (
...
SCOPE_PACKS: dict[str, tuple[tuple[str, tuple[str, ...]], ...]] = {
    ...
    "academic": (("academic_discovery", ("core", "vertical")),),
    "standards": (("standards_research", ("core", "vertical")),),
    ...
    "science": (("academic_discovery", ("core", "vertical")), ("tech_research", ("vertical",))),
...
INTENT_PACKS: dict[str, tuple[str, ...]] = {
    ...
    "academic": ("academic_discovery",),
    "standards_compliance": ("standards_research",),
...
INTENT_SCOPE_FILTERS: dict[str, set[str]] = {
    ...
    "science": {"science"},
    "academic": {"academic"},
    "standards_compliance": {"standards", "global_official", "gov"},
