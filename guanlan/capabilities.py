...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        id="entertainment",
        name="文娱路由",
        description="把影视、综艺、音乐、游戏、明星、票房、播放热度和口碑问题路由到豆瓣、猫眼/灯塔、B站、微博、TapTap 等文娱与公开讨论来源。",
        when_to_use="用户问电影/剧集/综艺/明星/游戏怎么样、票房热度、豆瓣评分、粉圈争议、文娱舆情或内容消费建议时。",
        cli=[
        ...
        boundary="文娱材料尤其容易受宣发、粉圈控评、平台算法和刷分影响；平台热度、评分、产业报道和公开讨论必须分层引用。",
        examples=["这部电影现在口碑怎么样？", "某综艺最近为什么上热搜？", "这个游戏值得玩吗？"],
    ),
    Capability(
        id="evidence_audit",
        name="证据审计",
