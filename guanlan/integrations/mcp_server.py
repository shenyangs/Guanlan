            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "no_cache": {
                        "type": "boolean",
                        "default": False,
                        "description": "Explicitly bypass both Guanlan local cache and Jina upstream cache.",
                    },
                    "jina_engine": {
                        "type": "string",
                        "enum": ["auto", "browser", "curl"],
                        "default": "auto",
                        "description": "Advanced opt-in engine control; auto preserves the compatibility path.",
                    },
                    "jina_format": {
                        "type": "string",
                        "enum": ["content", "frontmatter"],
                        "default": "content",
                        "description": "Advanced opt-in output control; content preserves the legacy response shape.",
                    },
                    "jina_wait_for": {"type": "string", "description": "Optional safe CSS wait selector."},
                    "jina_target": {"type": "string", "description": "Optional safe CSS target selector."},
                    "jina_remove": {"type": "string", "description": "Optional safe CSS selector list to remove."},
                    "jina_repair": {
                        "type": "boolean",
                        "default": True,
                        "description": "Allow one bounded browser repair only after Jina and direct both return a dynamic shell.",
                    },
