...
def main():
    ...
    p_hotnews.add_argument("source", nargs="?", default="today",
                           help="Source id: today, tech, alerts, snapshot, baidu, weibo, bilibili-hot-search, bilibili, ithome, sspai, xinzhiyuan, youtube-ai-rss, hackernews, linuxdo, cisa-kev, usgs-earthquakes, zeli-hn, buzzing, zhihu, v2ex, ebrun:<channel>, newsnow:<id>, vvhan:<id>, uapis:<id>, tophub:<id>, hotboard:<id>, or list")
