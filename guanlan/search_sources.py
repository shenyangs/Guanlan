...
SEARCH_SCOPES: dict[str, SearchScope] = {
    ...
    "wps_office": SearchScope(
        id="wps_office",
        name="金山办公/WPS 与 AI Office",
        description="适合 WPS、WPS AI、WPS 365、AI 办公、PPT/文档/表格/PDF、协同办公、SaaS、信创、安全和办公 Agent 选题线索。",
    ...
    "standards": SearchScope(
        id="standards",
        name="标准、规范与合规原文",
        description="适合国家标准、国际标准、互联网 RFC、Web 规范、电信标准和合规控制原文核验。",
        source_type="标准/规范/合规原文",
        trust_level=5,
        domains=(
            "std.samr.gov.cn",
            "samr.gov.cn",
...
SEARCH_SCOPE_ALIASES = {
    ...
    "productivity": "wps_office",
    "office-suite": "wps_office",
    "ppt": "wps_office",
    ...
    "app-review": "market_review",
    "app_review": "market_review",
    "appstore": "market_review",
    "play-store": "market_review",
    "aso": "market_review",
    ...
    "manga": "entertainment",
    "comic": "entertainment",
    "light-novel": "entertainment",
    "light_novel": "entertainment",
    "bangumi": "entertainment",
    "pixiv": "entertainment",
    ...
    for index, scope in enumerate(scopes):
        for candidate in scope.domains:
            if normalized == candidate or normalized.endswith("." + candidate):
                priority = -1 if preferred_scope and scope.id == preferred.id else scope_priority.get(scope.id, index + 20)
